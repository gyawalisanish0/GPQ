...
export class BaseScene extends Phaser.Scene {
    ...
    protected updateDimensions() {
        ...
        // FIX: Clamp scaleFactor to a safe minimum so it never collapses to 0,
        // which would produce invalid fontSize/size values and crash scene creation.
        this.scaleFactor = Math.max(
            0.1,
            Math.min(this.gameWidth / 1080, this.gameHeight / 1920)
        );
    }
